const themes = {
  defaultTheme: {
    ...
    "--el-yike-bgColorTop": "#fff",
    "--el-yike-bgColorBase": "#F4F4F5",
    "--el-yike-bgColorBottom": "#DDDFE4",
    "--el-yike-bgColorOther": "#F4F4F5",
    "--el-yike-fontColorTop": "#1F1D2B",
    "--el-yike-fontColorBase": "#3B3948",
    "--el-yike-fontColorBottom": "#9195A1",
  },
  darkTheme: {
    "color-scheme": "dark",
    ...
    "--el-border":
      "var(--el-border-width) var(--el-border-style) var(--el-border-color)",
    "--el-svg-monochrome-grey": "var(--el-border-color)",
    "--el-yike-bgColorTop": "#202025",
    "--el-yike-bgColorBase": "#17161B",
    "--el-yike-bgColorBottom": "#2E2E35",
    "--el-yike-bgColorOther": "#2E2E35",
    "--el-yike-fontColorTop": "#fff",
    "--el-yike-fontColorBase": "#DDDFE4",
    "--el-yike-fontColorBottom": "#9195A1",
  },
};
